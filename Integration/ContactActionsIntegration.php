...
class ContactActionsIntegration extends AbstractIntegration
{
    const INTEGRATION_NAME = 'ContactActions';
    ...
    {
        return 'plugins/MauticContactActionsBundle/Assets/img/icon.png';
    }
    ...
    public function appendToForm(&$builder, $data, $formArea)
    {
        if ($formArea == 'features') {
            $builder->add(
                ...
                [
                    'label'                 => 'mautic.contactactions.sync.country_iso_code',
